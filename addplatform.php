        ...
        <div class="col-md-10" style="">
            <ul class="list-inline" style="margin:0px">
                <li class="list-inline-item">
                    <a href="/gms/showcat" class="btn btn-default" style="margin:0px;"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Back to Manage Games Platform</a>
                </li>
            </ul>
        </div>
        <div class="col-md-1"></div>
        ...
        <div class="col-md-10" style="background-color:">
            <div class="container-fluid z-depth-3" style="background-color:#fafafa ">
                <div class="row">
                    ...
                    <div class="col-md-3 z-depth-2  waves-effect" style="padding:0px;background-color:#fafafa;color:whte">
                    ...
                    <div class="col-md-9" style="background-color:#fafafa ">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <form-group>
                                            <label style="font-size:100%">Game Platform Name</label>
                                            <input type="text" placeholder="Enter Book Category Name" name="b_cat_name" style="font-size:125%">
                                    </form-group>
                                </div>
                            </div>
                            <div class="row">
