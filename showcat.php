                ...
                <table class="table table-striped table-hover ">
                    ...
                    <?php 
                        ...
                        while($row = $result->fetch_assoc()){
                            ...
                            $output ='<tr>';
                            $output .='<td style="font-size:120%">'.$row['GC_NAME'].'</td>';
                            $output .='<td class="no-print"><a style="margin:0px" href="/gms/editcat/'.$row['GC_ID'].'" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a></td>';
                            $output .='<td class="no-print"><a style="margin:0px" onclick="pop()" href="/gms/delete_cat/'.$row['GC_ID'].'" class="btn btn-danger"><i class="fa fa-remove" aria-hidden="true"></i> Delete</a></td>';
                            $output .='</tr>';
